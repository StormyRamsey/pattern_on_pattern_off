...
ActiveRecord::Schema.define(version: 20170607210442) do
  ...
  create_table "comments", force: :cascade do |t|
    ...
    t.string   "photo_url"
    t.index ["yarn_id"], name: "index_comments_on_yarn_id", using: :btree
  end
  ...
  create_table "patterns", force: :cascade do |t|
    ...
    t.integer  "user_id"
    t.index ["user_id"], name: "index_patterns_on_user_id", using: :btree
  end
  ...
  add_foreign_key "comments", "yarns"
